$(document).ready(function () {
    ...
    $("#registroinicio").validate({
      ...
      messages: {
        ...
        telefono: {
          required: "Ingrese su telefono celular.", minlength: "El telefono movil es de minimo 10 caracteres." 
        },
  
        fecha_nacimiento: {
          required: "Ingrese su fecha de nacimiento.",
          max: "Usted debe ser mayor de edad para poder registrarse en el sistema."
        },
  
        direccion: {
          required: "Ingrese su dirección de residencia." 
        },
