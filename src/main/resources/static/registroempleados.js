$(document).ready(function () {
  ...
  $("#rempleados").validate({
    ...
    messages: {
      nombre: {
        required: "Ingrese el nombre completo del usuario."
      },

      apellido: {
        required: "Ingrese los apellidos completos del usuario."
      },

      clave: {
        required: "Ingrese la contraseña designada para el usuario.", 
      ...
      fecha_nacimiento: {
        ...
        max: "El usuario debe ser mayor de edad para poder ser registrado en el sistema."
      },
