...
public class DomicilioControl {
	...
	@GetMapping("/camEstadoDomi/{id_domicilio}")
	public String camestadodomi (Usuario usuario, Model model, @PathVariable("id_domicilio") Integer id_domicilio){
	service.ActualizarDomi(id_domicilio);	
	model.addAttribute("identificador", nombre.identificador);
	return "redirect:/Historial_Entregas";
	}
