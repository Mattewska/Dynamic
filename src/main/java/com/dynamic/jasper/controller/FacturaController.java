...
public class FacturaController {
	...
	@GetMapping(path = "factura/download")
	
	public ResponseEntity<Resource> fadownload (@RequestParam Map<String, Object> params) throws JRException, IOException, SQLException{
	FacturaDTO dto = facturaservice.factura(params);
